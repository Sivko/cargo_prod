...
export type TDocument = DocumentPickerResponse;

export interface FilePicker {
  onSelect(_: TDocument[]): void;
}

export const FilePicker: FC<FilePicker> = ({onSelect}) => {
  const [result, setResult] = useState<TDocument[]>([]);
  ...
  const deleteFile = (item: TDocument, index: number) => {
